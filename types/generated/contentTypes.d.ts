...
export interface ApiCargoCargo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    id_departamento: Schema.Attribute.Relation<
      'manyToOne',
    ...
    nivel: Schema.Attribute.Enumeration<
      ['junior', 'mid-senior', 'senior', 'gerente', 'presidente']
    >;
...
export interface ApiCategoriaManualCategoriaManual
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorias_manuales';
  info: {
    description: '';
    displayName: 'Categoria_Manual';
    pluralName: 'categorias-manuales';
    singularName: 'categoria-manual';
  };
  options: {
    draftAndPublish: true;
    privateAttributes: ['createdAt', 'updatedAt', 'publishedAt'];
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categoria-manual.categoria-manual'
    > &
      Schema.Attribute.Private;
...
export interface ApiDepartamentoDepartamento
  ...
  attributes: {
    cargos: Schema.Attribute.Relation<'oneToMany', 'api::cargo.cargo'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    linea_negocio: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::departamento.departamento'
...
export interface ApiEmpleadoManualEmpleadoManual
  extends Struct.CollectionTypeSchema {
  collectionName: 'empleados_manuales';
  info: {
    description: '';
    displayName: 'Empleado_Manual';
    pluralName: 'empleados-manuales';
    singularName: 'empleado-manual';
  };
  options: {
    draftAndPublish: true;
    privateAttributes: ['createdAt', 'updatedAt', 'publishedAt'];
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fecha_lectura: Schema.Attribute.Date;
    leido: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::empleado-manual.empleado-manual'
    > &
      Schema.Attribute.Private;
    progreso_lectura: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
